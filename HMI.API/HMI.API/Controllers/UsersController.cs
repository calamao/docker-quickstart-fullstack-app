...
namespace HMI.API.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        {
            var requester = this.userService.GetUser(this.RequesterId);
        ...
        {
            var user = this.userService.Create(requestData);
            return this.Created(string.Empty, user);
        }
        ...
        public ActionResult<UserResponse> Update(int id, UpdateUserRequest requestData)
        {
            ...
            {
                requestData.Role = this.userService.GetUser(id).Role;
            }

            var user = this.userService.Update(id, requestData);
        ...
        {
            this.userService.ResetPassword(this.RequesterId, requestData);
        ...
        {
            this.userService.ResetPassword(requestData);
            return this.Accepted();
        }
