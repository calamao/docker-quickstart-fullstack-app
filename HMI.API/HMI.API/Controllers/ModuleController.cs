...
namespace HMI.API.Controllers
{
    ...
    public class ModuleController : BaseController
    {
        ...
        public ActionResult<IEnumerable<Module>> GetAll()
        {
            ...
            return this.Ok(this.moduleService.GetAll());
        }
        ...
        {
            this.logger.LogDebug($"Get module request received. Module moduleId: {moduleId}");
            return this.Ok(this.moduleService.GetById(moduleId));
        }
        ...
        {
            this.logger.LogDebug($"Get current operation status request received. Module moduleId: {moduleId}");
            return this.Ok(this.moduleService.CurrentOperation(moduleId));
        }
        ...
        {
            this.logger.LogDebug($"Get process status request received. Module moduleId: {moduleId}");
            return this.Ok(this.moduleService.ProcessStatus(moduleId));
        }
        ...
        {
            this.logger.LogDebug($"Get hardware status request received. Module moduleId: {moduleId}");
            return this.Ok(this.moduleService.HardwareStatus(moduleId));
        }
    }
}
