...
namespace HMI.API.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        public Item Get(string itemName)
            => this.itemsService.Get(itemName);
        #endregion
        ...
        {
            var item = this.itemsService.CreateItem(itemName);
        ...
        {
            var tag = this.itemsService.CreateTag(itemName, tagLabel);
        ...
        {
            var item = this.itemsService.DeleteItem(itemName);
