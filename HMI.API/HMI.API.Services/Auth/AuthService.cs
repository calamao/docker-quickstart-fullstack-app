...
namespace HMI.API.Services.Auth
{
    ...
    public class AuthService : IAuthService
    {
        ...
        {
            var user = this.context.Users.SingleOrDefault(x => x.Username == model.Username);
        ...
        {
            var (refreshToken, user) = this.GetRefreshToken(token);
        ...
        {
            var requester = this.context.Users.Find(requesterId);
